{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "7494a64d-d6a2-4f34-b79e-1e42dc196e55",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[7:0]",
        ...
        {
          "id": "18cf9d3b-b151-4ac0-b996-06aa6573118d",
          "type": "9d2f632beb54fb1f71ac9e6568469f6027aceb53",
          "position": {
            "x": 1288,
            "y": -64
          },
        ...
        {
          "id": "c4ad96ea-6fd0-482d-a353-896d2befba24",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "18cf9d3b-b151-4ac0-b996-06aa6573118d",
            "port": "3ac469d7-5e0e-4b49-b0a5-1a2c7ea264d7"
          }
        },
        {
          "source": {
            "block": "c4ad96ea-6fd0-482d-a353-896d2befba24",
            "port": "5b1bcd2c-0b1e-44fc-8073-342a0909b7b5"
          },
          "target": {
            "block": "7494a64d-d6a2-4f34-b79e-1e42dc196e55",
            "port": "in"
          },
          "size": 8
        },
  ...
  "dependencies": {
    "9d2f632beb54fb1f71ac9e6568469f6027aceb53": {
      "package": {
        "name": "sysclk_divN_2bits",
        "version": "0.1",
        "description": "sysclk_divN_2bits: Generate a signal from the division of the system clock by N. (2-bits precision) (N = 2,3,4)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "2893a3fb-9a29-4015-8be4-eba194a8af1b",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "2893a3fb-9a29-4015-8be4-eba194a8af1b",

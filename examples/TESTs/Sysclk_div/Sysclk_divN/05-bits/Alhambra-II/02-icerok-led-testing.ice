  ...
  "dependencies": {
    ...
    "fe49f03379e8721a257b88aedeba8f527a38945b": {
      "package": {
        "name": "sysclk_divN_4",
        "version": "0.1",
        "description": "sysclk_divN_4bits: Generate a signal from the division of the system clock by N. (4-bits precision) (N = 2,3,4,..,16)",
        "author": "Juan González-Gómez (Obijuan)",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "203a8385-4e31-4ecc-bbf0-0cdd4a634795",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "203a8385-4e31-4ecc-bbf0-0cdd4a634795",
